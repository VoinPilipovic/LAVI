...
export async function getBlockedSlots(): Promise<
  ActionResult<Tables<"blocked_slots">[]>
> {
  try {
    ...
    if (error) {
      return {
        success: false,
        error: "Could not load blocked slots.",
      };
    }
...
export async function createBlockedSlot(
  ...
  try {
    ...
    if (error) {
      return {
        success: false,
        error: "Could not create blocked slot.",
      };
    }
...
export async function deleteBlockedSlot(
  ...
  try {
    ...
    if (error) {
      return {
        success: false,
        error: "Could not remove blocked slot.",
      };
    }
